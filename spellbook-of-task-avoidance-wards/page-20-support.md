...
[![ko-fi · multiverselibcollectives](assets/kofi-button.svg)](https://ko-fi.com/multiverselibcollectives)

<!-- ko-fi-embed-start -->
<script src='https://storage.ko-fi.com/cdn/button-basic.min.js' data-color='#674188' data-background='#0f0f1a' data-text='support on Ko-fi' data-hide-counter='false' data-font='monospace' data-emoji='☕'></script>
